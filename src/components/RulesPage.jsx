...
function RulesPage() {
  return (
    <div className="rules">
      ...
      <ul>
        <li>
          A secret word will be chosen at random, and you have to guess it.
        </li>
        ...
        <li>
          If a letter is in the correct position, it will be highlighted in
          green.
        </li>
        <li>
          If a letter is in the word but in the wrong position, it will be
          highlighted in yellow.
        </li>
        <li>If a letter is not in the word at all, it will be greyed out.</li>
        <li>
          You win by guessing the word within the allowed number of attempts.
        </li>
      </ul>
